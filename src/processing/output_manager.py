...
class OutputManager:
    ...
    def move_icontools_output(self, grid_manager, domain_ids, keep_basegrid_files, logging_indentation_level=0):
        ...
        for domain_id in domain_ids:
            ...
            self.move_files(os.path.join(icontools_dir, grid_manager.icon_gridgen_namelist_filename), namelists_domain_dir, logging_indentation_level=logging_indentation_level+1)
