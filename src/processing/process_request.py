...
def main(config_path, workspace_path, extpar_raw_data_path, zonda_log_filename, use_apptainer):
    ...
    for nesting_group_idx, nesting_group in enumerate(nesting_groups):
        ...
        try:
            visualization_manager.visualize_data(nesting_group, grid_manager.grid_dirs, grid_manager.grid_filenames, extpar_manager.extpar_dirs, logging_indentation_level=2)
        except Exception as e:
